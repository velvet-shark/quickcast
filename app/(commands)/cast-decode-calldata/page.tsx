...
import { RunCalldataDecode } from "@/app/components/commands/run-decode-calldata";
  ...
  const examples = (
    <>
      <Example
        ...
        command='cast decode-calldata "transfer(address,uint256)" 0xa9059cbb000000000000000000000000e78388b4ce79068e89bf8aa7f218ef6b9ab0e9d0000000000000000000000000000000000000000000000000008a8e4b1a3d8000'
...
39000000000000000 [3.9e16]`}
      ...
      <Example
        ...
        command='cast decode-calldata "approve(address,uint256)" 0x095ea7b300000000000000000000000090c1f9220d90d3966fbee24045edd73e1d588ad500000000000000000000000000000000000000000000000000000000000003e8'
